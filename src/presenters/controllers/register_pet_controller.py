    ...
    def router(self, http_request: Type[HttpRequest]) -> HttpResponse:
        ...
        if http_request.body:
            ...
            if (
                ...
                user_information = http_request.body["user_information"].keys()

                if "user_id" in user_information or "user_name" in user_information:
